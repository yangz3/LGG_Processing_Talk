...
- (void)readIn:(NSString *)s {
	...
	NSLog(@"%@", s);
    [self.delegate Communicator:self receivedMessage:s];
    
}

// TCP socket can only take string(printable) as data stream.
// otherwise the newline will easily be triggered by data
